...
struct PomodoroView: View {
    ...
    var body: some View {
                        ...
                        Circle()
                            ...
                            .overlay {
                                Circle()
                                    ...
                                    .stroke(themeColor, style: StrokeStyle(lineWidth: 2.0, lineCap: .round, lineJoin: .round))
        ...
        .onReceive(secondTimer) { _ in
            ...
            if elapsedTime >= Config.POMODORO_TIME_MINUTE , elapsedTime.truncatingRemainder(dividingBy: Config.POMODORO_TIME_MINUTE) == 0 {
